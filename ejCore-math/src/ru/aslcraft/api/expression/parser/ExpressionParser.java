...
import static ru.aslcraft.api.expression.EnumBinaryOperation.Undefined;
import static ru.aslcraft.api.expression.EnumBinaryOperation.getOpByString;
import static ru.aslcraft.api.expression.EnumBinaryOperation.getStringByOp;
import static ru.aslcraft.api.expression.EnumBinaryOperation.levels;
...
import ru.aslcraft.api.expression.exceptions.IllegalOperatorException;
import ru.aslcraft.api.expression.exceptions.MismatchArgumentException;
...
import ru.aslcraft.api.expression.operations.Add;
import ru.aslcraft.api.expression.operations.Const;
import ru.aslcraft.api.expression.operations.Divide;
import ru.aslcraft.api.expression.operations.Log;
import ru.aslcraft.api.expression.operations.Mod;
import ru.aslcraft.api.expression.operations.Multiply;
import ru.aslcraft.api.expression.operations.Negate;
import ru.aslcraft.api.expression.operations.Pow;
import ru.aslcraft.api.expression.operations.Subtract;
import ru.aslcraft.api.expression.operations.Variable;
