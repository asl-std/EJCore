package ru.aslcraft.api.bukkit.message;
...
public class EText {
	 ...
	 * @param prefix a {@link java.lang.String} object
	 */
	public static void debug(String msg, String prefix) { if (debug) send("&5[&2"+ prefix +"&5]&f: &3> &e" + msg); }
	 ...
	 * {@link ru.aslcraft.api.bukkit.message.EText#sendRaw(Object)}
	 *
